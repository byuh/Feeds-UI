          ...
          success: function(data, status) {
            ...
            var SatTimeforLunch = item.node.SatTimeforLunch;
                ...
                if(n === "sunday"){
                    ...
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Breakfast("+ SundayTimeforBreakfast+")</div><div class='meals'>"+ BreakfastforSunday +"</div></div>");
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Lunch("+ SundayTimeforLunch+")</div><div class='meals'>"+ LunchforSunday +"</div></div>");
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Dinner("+ SundayTimeforDinner+")</div><div class='meals'>"+ DinnerforSunday +"</div></div></div>");
                }
                if(n === "monday"){
                   $('.mainbody').append("<div class='container-fluid'><div class='row'><div class='col-xs-12 dinning-head' <center>" + DateforMonday+ "</center></div></div>");
                    $('.mainbody').append("<div class='row'>");
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Breakfast("+ MonFriTimeforBreakfast+")</div><div class='meals'>"+ BreakfastforMonday +"</div></div>");
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Lunch("+ MonFriTimeforLunch+")</div><div class='meals'>"+ LunchforMonday +"</div></div>");
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Dinner("+ MonFriTimeforDinner+")</div><div class='meals'>"+ DinnerforMonday +"</div></div></div>");
                }
                if(n === "tuesday"){
                  $('.mainbody').append("<div class='container-fluid'><div class='row'><div class='col-xs-12 dinning-head' <center>" + DateforTuesday+ "</center></div></div>");
                    $('.mainbody').append("<div class='row'>");
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Breakfast("+ MonFriTimeforBreakfast+")</div><div class='meals'>"+ BreakfastforTuesday +"</div></div>");
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Lunch("+ MonFriTimeforLunch+")</div><div class='meals'>"+ LunchforTuesday +"</div></div>");
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Dinner("+ MonFriTimeforDinner+")</div><div class='meals'>"+ DinnerforTuesday +"</div></div></div>");
                }
                if(n === "wednesday"){
                ...
                if(n === "saturday"){
                    ...
                    $('.mainbody').append("<div class='row'>");
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Breakfast("+ SatTimeforBreakfast+")</div><div class='meals'>"+ BreakfastforSaturday +"</div></div>");
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Lunch("+ SatTimeforLunch+")</div><div class='meals'>"+ LunchforSaturday +"</div></div>");
                    $('.mainbody').append("<div class='col-lg-4 dinning-body'><div class='meal-time'>Dinner("+ SatTimeforDinner+")</div><div class='meals'>"+ DinnerforSaturday +"</div></div></div>");
                }
                $('.mainbody').append("<div class='meals'><a href='http://foodservices.byuh.edu/menu'> Click Here For The Full Menu</a></div>");
